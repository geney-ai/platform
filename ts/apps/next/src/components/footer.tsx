    ...
    <footer className="bg-foreground text-background w-full">
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-start">
          <div>
            <h3 className="text-lg font-semibold mb-4">Geney</h3>
            <p className="text-sm opacity-90">
              AI-powered biochemistry research.
            </p>
          </div>
          {/* TODO (amiller68): add social media links */}
          {/* <div>
        ...
        <div className="mt-8 pt-8 border-t border-background/10 flex justify-between items-center text-sm opacity-75">
          <div>
            &copy; {new Date().getFullYear()} Geney. All rights reserved.
          </div>
          <button
